...
function ManageCourses() {
  return (
    <div>
      <Navbar />
      <center>
        <h1 className="text-2xl font-bold mt-16">Manage Courses</h1>
      </center>
      ...
      <form className="max-w-md mx-auto mt-10">
        ...
        <div className="relative">
          ...
          <input
            type="search"
            id="default-search"
            className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-black-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-black-500"
