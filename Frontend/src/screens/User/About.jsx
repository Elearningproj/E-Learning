...
function About(){
    ...
    return(
     ...
     <div className='row'>
      <div className='col'>
      <a href="#" class="about">
        <img src="../../images/User/about1.png" height={"200"} width={"200px"}/>
      </a>
      </div>
      <div className='col'>
      <a href="#" class="about">
        <img src="./image/about2.png" height={"200px"} width={"200px"}/>
      </a>
      </div>
      <div className='col'>
      <a href="#" class="about">
        <img src="./image/about3.png" height={"200px"} width={"200px"}/>
      </a>
      </div>
      </div>
     </div>
