...
function Footer() {
  return (
    ...
    <footer className="bg-[#eca444] rounded-lg shadow-sm dark:bg-black-900 m-4">
      <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          >
            <img src={logoImg} className="h-8" alt="ELearn Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-[#4a3f3c]">
              ELearn
            </span>
          </a>
        ...
        <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">
          © Since 2024. Contact us . +9556569676 .
        </span>
      </div>
    </footer>
  );
