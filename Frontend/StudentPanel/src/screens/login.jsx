...
function Login() {
  ...
  return (
   <body style={{backgroundImage:"url('/image/logn.jpg')",backgroundSize:"cover", backgroundPosition:"center" ,height:"400px"}}>
    ...
    <div >
      ...
      <div className='row' > 
        ...
        <h2 className='header'><b>Welcome !</b></h2>
        <h2 className='header'>Login</h2>
          ...
          <div className='mt-3'>
            ...
            <button onClick={onLogin} className='btn btn-success mt-3' ><Link to="/home">   </Link>
              Login
            </button>
          </div>
        </div>
